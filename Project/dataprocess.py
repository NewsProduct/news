...
def dataprocess(train_path="E:/New新闻摘要/dataset/train_dataset.csv",test_path= "E:/New新闻摘要/dataset/test_dataset.csv"):
    # 数据清洗
    def _clean(data):
        print("数据清洗开始...")
        clean_data = []
    ...
    new_train_path = os.path.join("E:/New新闻摘要/dataset/new_train/")
    new_val_path = os.path.join("E:/New新闻摘要/dataset/new_val/")
    new_test_path = os.path.join("E:/New新闻摘要/dataset/new_test/")
...
def creat_VocabCounter(data_dir="E:/New新闻摘要/dataset/"): #统计词汇建词频表
